<%@ page import="shopping.entity.User" %>
...
<head>
    ...
    <style>
        /* styles.css */
        body {
            background-image: url('images/lybjt.jpg'); /* 替换为你的背景图片路径 */
...
<header>
    <p class="yinliao">
        <a href="homepage.jsp">欢迎您购买本店饮料(点这里可以返回哦)</a>
    </p>
</header>
...
<div class="container">
    ...
    <div class="product">
        ...
        <p>价格：¥<%= product.getPrice() %>
        </p>
        <button class="add-to-cart" data-cn="<%=product.getCategoryName()%>" data-name="<%= product.getName() %>" data-price="<%= product.getPrice() %>">
            加入购物车
        </button>
    </div>
    <%
...
<script>
    document.querySelectorAll(".add-to-cart").forEach((button) => {
        button.addEventListener("click", () => {
            ...
            const tp = button.getAttribute("data-cn");
