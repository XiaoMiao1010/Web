  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addUserModalLabel">添加公告</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="addUserForm">
          <div class="mb-3">
            <label for="addUsername" class="form-label">标题</label>
            <input type="text" class="form-control" id="addUsername" required>
          </div>
          <div class="mb-3">
            <label for="addPassword" class="form-label">内容</label>
...
<div class="modal fade" id="editUserModal" tabindex="-1" aria-labelledby="editUserModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editUserModalLabel">修改公告</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="editUserForm">
          ...
          <div class="mb-3">
            <label for="editUsername" class="form-label">标题</label>
            <input type="text" class="form-control" id="editUsername" required>
          </div>
          <div class="mb-3">
            <label for="editPassword" class="form-label">内容</label>
...
<script>
  $(document).ready(function () {
    ...
    $('#addUserForm').submit(function (event) {
      ...
      $.ajax({
        url: '/gonggao/add',  // 添加用户的Servlet路径
        type: 'POST',
    ...
    $('#editUserForm').submit(function (event) {
      ...
      $.ajax({
        url: '/gonggao/update',  // 更新用户的Servlet路径
        type: 'POST',
    ...
    $('#confirmDeleteBtn').click(function () {
      if (selectedUserId != null) {
        $.ajax({
          url: '/gonggao/delete',  // 删除用户的Servlet路径
          type: 'POST',
      ...
      success: function (data) {
        ...
        if (data && data.users) {
          ...
          if (data.users.length === 0) {
            $('#userList').append('<tr><td colspan="4" class="text-center">暂无公告</td></tr>');
          }
